...
CREATE TABLE public.products (
  ...
  brand text NOT NULL DEFAULT 'Hijabi By Anayah',
...
INSERT INTO public.payment_methods (code, label, note, discount_pct, enabled, requires_proof, account_title, account_number, iban, instructions, sort_order) VALUES
  ('cod','Cash on Delivery','Pay delivery charges in advance only',10,true,true,'Hijabi By Anayah','0343 5295541',NULL,'Only the delivery charges are paid in advance. Pay the rest to the courier.',1),
  ('easypaisa','EasyPaisa (Advance)','Full advance payment',15,true,true,'Hijabi By Anayah','0343 5295541',NULL,'Send the total to the EasyPaisa number and upload the screenshot.',2),
  ('jazzcash','JazzCash (Advance)','Full advance payment',15,true,true,'Hijabi By Anayah','0343 5295541',NULL,'Send the total to the JazzCash number and upload the screenshot.',3),
  ('bank','Bank Transfer (Advance)','Full advance payment',15,true,true,'Hijabi By Anayah','0102 0345 6789','PK36ANYH0000001020345678','Transfer to the account above and upload the receipt.',4);